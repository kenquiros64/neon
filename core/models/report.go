...
type Report struct {
	...
	Timetable           enums.Timetable `json:"timetable" db:"timetable" goqu:"omitempty"`
	...
	PartialCashReceived int             `json:"partial_cash_received" db:"partial_cash_received" goqu:"omitempty"`
	FinalTickets        int             `json:"final_tickets" db:"final_tickets" goqu:"omitempty"`
	FinalCash           int             `json:"final_cash" db:"final_cash" goqu:"omitempty"`
	FinalCashReceived   int             `json:"final_cash_received" db:"final_cash_received" goqu:"omitempty"`
	...
	RemoteSynced        bool            `json:"remote_synced" db:"remote_synced" goqu:"omitempty"`
}
